...
Route :: get('/sms-testing', 'HomeController@smstest');
Route :: get('/about-us', 'HomeController@about');
Route :: get('/test-mail/{id}', 'HomeController@sendInvoiceMail');
...
Route :: get('/our-lab-report',  'HomeController@our_lab_report');
...
Route::get('/event-media/{event_url}', 'HomeController@event_details');

Route :: get('/photo-gallery',  'HomeController@photo_gallery');
Route :: get('/boss-ladies',  'HomeController@boss_ladies');
...
Route :: get('/check-out/cancel-payment', 'HomeController@cancel_payment');
...
Route::group(['prefix'=> 'my-profile', 'as'=> 'my-profile.'], function(){
    Route::post('/add-wishlist', 'UserProfile@addWishlist');
    Route::post('/remove-wishlist', 'UserProfile@removeWishlist');
...
Route::group(['prefix'=> 'admin', 'as'=> 'admin.'], function(){
    ...
    Route::post('/get-single-data', 'ShopController@get_single_data');
    ...
    Route::group(['prefix'=> 'shop', 'as'=> 'shop.'], function (){
        ...
        Route::get('/healthbox-faq/{id}', 'ShopController@healthbox_faq');
        Route::post('/healthbox-faq', 'ShopController@post_healthbox_faq');
  ...
  //    banner start
        Route::get('/new-event', 'ShopController@new_event');
        Route::post('/new-event', 'ShopController@post_new_event');
        Route::get('/shop-event', 'ShopController@shop_event');
        Route::get('/update-event/{id}', 'ShopController@update_event');

        Route::get('/shop-event-gallery/{id}', 'ShopController@event_gallery');
        Route::post('/shop-event-gallery', 'ShopController@post_event_gallery');
