...
<div id="container">
    <div class="login">
        <div class="content">
            ...
            <form method="post" id="resetPassword" action="{!! url('/reset-password') !!}">
                ...
                <div class="login-content">
                    <div class="input-div one">
                        ...
                        <div class="div-box">
                            <input type="password" name="new_password" class="input" placeholder="New Password"  required="required" >
                        </div>
                    </div>
