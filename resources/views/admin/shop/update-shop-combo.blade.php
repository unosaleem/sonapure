                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control text-center" type="text" value="SPECP{!! isset($product) ? $product->sku_number : $last_id !!}" name="sku_number" required readonly style="padding: 6px;height: 44px;">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="row">
