            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Heath Box Banner</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h6>Add Banner Images</h6>
                            <span class="text-danger"> image size upload with <span class="text-success">1903w * 790h</span> and max <span class="text-success">file-size = 1mb</span></span>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{!! url('admin/shop/shop-healthbox-banner') !!}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        ...
                        <div class="row clearfix" id="add_gallery_div">
                            <div class="col-md-4">
                                ...
                                <input type="file" name="product_banner_image[]" data-id="0" class="image" required />
                            </div>
                        </div>
    ...
    <script type="application/javascript">
            ...
            $.confirm({
                ...
                buttons: {
                    Confirm: {
                        ...
                        action: function(){
                            $.post("{!! url('admin/shop/update-status') !!}", {'where[id]': id, 'input[is_active]': status, 'tab': "healthbox_banner", '_token': "{!! csrf_token() !!}"}, function(html){
        ...
        $(document).on("click", ".add_gallery_click", function(){
            ...
            div +='<div class="col-md-4">'+
                ...
                '<input type="file" name="product_banner_image[]" data-id="'+length+'"   class="image" >'+
                '</div>';
