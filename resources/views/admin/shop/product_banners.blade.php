    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Update Product Banners </h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Update Product Banners</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h6>Add Banners Images</h6>
                            <span class="text-danger"> image size upload with <span class="text-success">1600w * 600h</span> and max <span class="text-success">file-size = 1mb</span></span>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{!! url('admin/shop/shop-product-banners') !!}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-grid" style="padding: 0">
                                <div class="product-image">
                                    <img class="pic-1" src="{!! asset($row->image_url) !!}" style="width: 90%; height: 200px !important;">
            ...
            $.confirm({
                ...
                buttons: {
                    Confirm: {
                        ...
                        action: function(){
                            $.post("{!! url('admin/shop/update-status') !!}", {'where[id]': id, 'input[is_active]': status, 'tab': "product_gallery", '_token': "{!! csrf_token() !!}"}, function(html){
