            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Update Product Gallery</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <span class="text-danger"> image size upload with <span class="text-success">500w * 400h</span> and max <span class="text-success">file-size = 1mb</span></span>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{!! url('admin/shop/shop-product-gallery') !!}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
