            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item "><a href="{!! url('admin/shop/new-event') !!}">New Event</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="card mb-5">
                <div class="card-body">
                    <div class="row">
                        @if(count($shop_event) !=0)
                            @foreach($shop_event as $key=>$row)
                                <div class="col-md-4 p-3">
                                    <div class="card  m-3 shadow-lg">
                                        <p class=""> <span class=" text-right" style="float: right;"> <a href="{!! url('admin/shop/shop-event-gallery', $row->id) !!}" class="btn btn-primary">Add Gallery</a></span></p>
                                        <img src="{!! URL::asset($row->image) !!}" class=" card-img " alt="thumb">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                <div class="col-5">
                                                    {!! ucfirst($row->title) !!} <br>
                                                    @if($row->is_active == '1')
                                                ...
                                                <div class=" col-7 ">
                                                    ...
                                                    @endif
                                                    <a href="{!! url('admin/shop/update-event', base64_encode($row->id)) !!}" class="btn btn-primary btn-lg ms-1" title="Edit">Edit</a>
                                                </div>
                                            </div>
...
@section('script-function')
    <script>
        $(document).on("click", ".status", function (){
            ...
            $.confirm({
                title: 'Confirm!',
                content: 'Are you sure do u want '+(status == '1' ? "active" : "Non-Active")+' this Event',
                buttons: {
                    confirm: {
                        text: 'Yes',
                        btnClass: 'btn-blue',
