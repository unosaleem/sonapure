    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Update Heath Box</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Update Heath Box</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">SKNU Number</label>
                            ...
                            {{--<div class="col-md-2">
                                <div class="mb-3 ">
                                    ...
                                    <input class="form-control" type="text" value="{!! isset($product) ? $product->batch_no : "" !!}" name="batch_no" style="height: 44px;width: 100%" required/>
                                </div>
                            </div>--}}
                            <div class="col-md-12">
                                <div class="mb-3 ">
                            ...
                            {{--<div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <textarea class="form-control editor" rows="7" style="height: 200px;" name="interesting_facts" id="interesting_facts" placeholder="Interesting Facts" required>{!! (isset($product) ? $product->interesting_facts  : "") !!}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <textarea class="form-control editor" rows="7" style="height: 200px;" name="health_benefits" id="health_benefits" placeholder="Health  Benefits" required>{!! (isset($product) ? $product->health_benefits  : "") !!}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <textarea class="form-control editor" rows="7" style="height: 200px;" name="storage_instructions" id="storage_instructions" placeholder="Storage Instructions" required>{!! (isset($product) ? $product->storage_instructions  : "") !!}</textarea>
                                </div>
                            </div>--}}
                            <div class="col-md-4">
                                <div class="mb-3 ">
                            ...
                            {{--<div class="col-md-4">
                                <div class="mb-3 ">
                                    <label>Banner 1600px * 664px</label>
