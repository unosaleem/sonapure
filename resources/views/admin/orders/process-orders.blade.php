    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Process Orders</h4>
                                            ...
                                            <div class="dropdown ms-auto" style="float: right">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    @if($row->status == "process")
                                                        <a href="javascript:void(0)" data-id="{!! $row->order_id !!}" class="dropdown-item shipOrder">Shipment Order</a>
                                                    @endif
                                                    <a href="javascript:void(0)" data-id="{!! $row->id !!}" class="dropdown-item">Order Details</a>
