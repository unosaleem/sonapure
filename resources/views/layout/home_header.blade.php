          ...
          <div class="container">
              <div class="wrapper">
                  ...
                  <ul class="nav-links">
                          ...
                          <ul class="drop-menu">
                             ...
                             <li><a href="{!! url('our-essence') !!}">Our Essence</a></li>
							  ...
							  <li><a href="{!! url('our-team') !!}">Our Team</a></li>
							   <li><a href="{!! url('our-associates-partners') !!}"> Our Associates and Partners</a></li>
                          </ul>
                      </li>
                      <li>
                                              ...
                                              <ul class="nav nav-tabs tabs-left" id="style-scroll">
                                                  @foreach($product as $key=>$row)
                                                      <li class="{!! $key == '0' ? "active" : "" !!}">
                                                          <a href="#{!! $row->product_url !!}" data-toggle="tab">{!! $row->product_title !!}</a>
                      ...
                      <li><a href="{!! url('the-health-box') !!}">Our Gift Hamper</a></li>
                          ...
                          <li class="nav-item">
                              ...
                              <div class="shopping-cart">
                                  ...
                                  <a href="{!! url('/cart') !!}" class="button">
                                      <i class="fa fa-check" aria-hidden="true"></i> Go To Cart
                                  </a>
                              </div>
                          </li>
                          <li class="nav-item">
                              <div class="right">
                                  ...
                                  @else
                                      ...
                                      <div class="login">
                                          <div class="triangle"></div>
                                          <ul>
                                              <li><a href="{!! url('signin') !!}"> Login Account </a></li>
                                          </ul>
                                      </div>
                                  @endif
